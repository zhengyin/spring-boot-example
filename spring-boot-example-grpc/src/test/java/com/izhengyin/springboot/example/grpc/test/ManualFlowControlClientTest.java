...
public class ManualFlowControlClientTest {
    private static final Logger logger = Logger.getLogger(ManualFlowControlClientTest.class.getName());
    @Test
