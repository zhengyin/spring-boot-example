...
import com.izhengyin.springboot.example.grpc.manualflowcontrol.HelloReply;
import com.izhengyin.springboot.example.grpc.manualflowcontrol.HelloRequest;
import com.izhengyin.springboot.example.grpc.manualflowcontrol.StreamingGreeterGrpc;
...
public class ManualFlowControlServer {
    ...
    public void start() throws Exception{
        StreamingGreeterGrpc.StreamingGreeterImplBase svc = new StreamingGreeterGrpcImpl();
    ...
    public static class StreamingGreeterGrpcImpl extends StreamingGreeterGrpc.StreamingGreeterImplBase{
        @Override
