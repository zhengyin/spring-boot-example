...
public interface RouteNoteOrBuilder extends
   ...
   * @return The location.
   */
  com.izhengyin.springboot.example.grpc.routeguide.Point getLocation();
  /**
   * <pre>
   * The location from which the message is sent.
   * </pre>
   ...
   * <code>.routeguide.Point location = 1;</code>
   */
  com.izhengyin.springboot.example.grpc.routeguide.PointOrBuilder getLocationOrBuilder();
